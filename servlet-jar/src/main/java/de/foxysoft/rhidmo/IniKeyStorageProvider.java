...
public class IniKeyStorageProvider implements KeyStorageProvider {
  ...
  public void setAlgorithmName(String algorithm) {
    ...
    for (this.algorithmIndex = 0;
        algoTable[this.algorithmIndex][0].length() > 0;
        this.algorithmIndex++) {
      if (algoTable[algorithmIndex][0].equalsIgnoreCase(algorithm)) break;
    }
    ...
    LOG.debug(
        M + "Algorithm = {} {} {}, Index = {}",
        algoTable[this.algorithmIndex][1],
        algoTable[this.algorithmIndex][2],
        algoTable[this.algorithmIndex][4],
        this.algorithmIndex);
  }
  ...
  public String getDefaultCipherName() {
    ...
    for (; algoTable[defaultIndex][0].length() > 0; defaultIndex++) {
      if (algoTable[defaultIndex][0].equalsIgnoreCase(algorithm)) break;
    }
