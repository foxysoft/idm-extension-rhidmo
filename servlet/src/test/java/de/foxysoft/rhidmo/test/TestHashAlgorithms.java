...
public class TestHashAlgorithms
{
	...
	{
		String hash = GlobalFunctions.uMD5(password1, null);
		if(!hash.equalsIgnoreCase("23cb2d3d426b10abdf03417cdb095f08")) {
			throw new Exception("ERROR: MD5 password1");
		}
		hash = GlobalFunctions.uMD5(password1, "");
		if(!hash.equalsIgnoreCase("23cb2d3d426b10abdf03417cdb095f08")) {
			throw new Exception("ERROR: MD5 password1 \"\"");
		}
		hash = GlobalFunctions.uMD5(password1, "UTF-8");
		if(!hash.equalsIgnoreCase("23cb2d3d426b10abdf03417cdb095f08")) {
	...
	{
		String hash = GlobalFunctions.uSHA1(password1, null);
		if(!hash.equalsIgnoreCase("{SHA}Y8G9w3Gr8Xk7wCpfl3mOr8KCbr4")) {
			throw new Exception("ERROR: SHA1 password1");
		}
		hash = GlobalFunctions.uSHA1(password1, "");
		if(!hash.equalsIgnoreCase("{SHA}Y8G9w3Gr8Xk7wCpfl3mOr8KCbr4")) {
			throw new Exception("ERROR: SHA1 password1 \"\"");
		}
		hash = GlobalFunctions.uSHA1(password1, "UTF-8");
		if(!hash.equalsIgnoreCase("{SHA}Y8G9w3Gr8Xk7wCpfl3mOr8KCbr4")) {
	...
	public void doSHA256Hash() throws Exception {
		if(!GlobalFunctions.uCompareHash(password1, "{SHA256}7YbB+DReRnxEus3w7kJUlw2OKsowoUmhKwQhguH8BK2YFGk3G1Wzbr5lvP7T04uY", "")) {
	...
	public void doSHA384Hash() throws Exception {
		if(!GlobalFunctions.uCompareHash(password1, "{SHA384}/5zB0epFRwh4T7z/MLcHEQ2crLXp3CPHtktTxVN13R6GcXl9RFFyT0B56CQCWMkiVXDjrNHNRtrdkUKbOQAHgg", "")) {
	...
	public void doSHA512Hash() throws Exception {
		if(!GlobalFunctions.uCompareHash(password1, "{SHA512}8gZc/haFuVaS/GxsVWimcgx8r8sPODQ3vHq8Qbx+vZNwMuH9L735Q8MnihzfgJcDeHn4olZG0i78Znw0Kg89rXIwoglLv4HiUCay5quUonc", "")) {
	...
	public void doPBKDF2withSHA1() throws Exception {
		...
		if(!GlobalFunctions.uCompareHash(password1, "{PBKDF2_SHA1}baneJs13pVtmXtIhkAlNAY6NxDeOoy11lrKc3lDl3BRobxUfO+rj8UCsYnwxoa6Z", "")) {
	...
	void computeAndCompare(String value, String algorithm, String charSet) throws Exception {
		String hash = GlobalFunctions.uGenHash(value, algorithm, charSet);
		if(!GlobalFunctions.uCompareHash(value, hash, charSet)) {
